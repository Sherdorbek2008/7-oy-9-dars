# Generated by Django 5.1.4 on 2025-01-19 06:14
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', models.SlugField(max_length=150, unique=True)),
                ('departament', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='shop.departamenent')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type_product', models.CharField(choices=[('t', 'Tonnes'), ('kg', 'Kilogrammes'), ('l', 'Litres'), ('ml', 'Millilitres')], default='kg', max_length=2)),
                ('size', models.CharField(choices=[('sm', 'Small'), ('md', 'Medium'), ('lg', 'Large'), ('elg', 'Extra Large')], default='sm', max_length=8)),
